    ...
    <div class="banner">
      <swiper class="swiImgs" :options="swiperOption" v-if="commodity.length!=0">
        <swiper-slide v-for="(item, index) in commodity" :key="index" class="item">
          <img :src="item" class="swiImg">
        </swiper-slide>
        <div class="swiper-button-next"></div>
        <div class="swiper-button-prev"></div>
        <div class="swiper-pagination" v-for="(item,index) in 3" :key="index" slot="pagination"></div> 
      </swiper>
    </div>
    <!-- /banner -->
  </div>
...
export default {
  ...
  data() {
    ...
    return {
      commodity: [
        "../../static/img/banner/carton4.jpg",
        "../../static/img/banner/carton5.jpg",
        "../../static/img/banner/carton6.jpg"
      ],
      imgIndex: 1,
      swiperOption: {
