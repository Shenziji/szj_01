<template>
  <div id="head">
     <!-- 小装饰s -->
        <div class="pgy">
            <span class="small_pgy"></span>
            <span class="big_pgy"></span>
        </div>
        <!-- 小装饰e -->
        ...
        <header id="header">
            <nav class="header_content ">
                <div id="logo">
                    <!-- <img src="" alt="鬼鬼个人博客"> -->
                    <a href="javascript:(0)">
                    	<span>鬼</span><span>鬼</span><span>の</span><span>博</span><span>客</span>
                    </a>
                </div>
...
<style>
 ...
 .pgy span {
    ...
    position: fixed;
    bottom: 0;
    background: url("../../static/img/pgy.png") no-repeat;
    z-index: 999;
}
...
.pgy .small_pgy {
    ...
    animation: yaobai 3s linear 1s infinite alternate;
}
...
#header .header_nav .nav_list .active{
    color: rgb(233, 58, 58);
}
#header .header_content .register {
    float: right;
}

#header .header_content .register>ul {
    height: 50px;
    margin: 5px 0;
}

#header .header_content .register>ul>li {
    float: right;
    min-width: 40px;
    height: 40px;
    line-height: 40px;
...
#header .header_content .register a {

    transition: color .3s;
}

#header .header_content .register a:hover {
    color: #eee;
}
/* logo文字跳动 */

#logo span:nth-child(1){
    animation: jump  .2s  5s alternate infinite;
}
#logo span:nth-child(2){
    animation: jump  .2s  5.1s alternate infinite;
}
#logo span:nth-child(3){
    animation: jump  .2s  5.2s alternate infinite;
}
#logo span:nth-child(4){
    animation: jump  .2s  5.3s alternate infinite;
}

#logo span:nth-child(5){
    animation: jump  .2s  5.4s alternate infinite;
}
